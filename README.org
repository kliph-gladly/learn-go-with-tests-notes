...
Ah =make= seems sort of like what I want.  =make= and =range= feel a little bit like initializing a collection and then =map=ping over a collection to transform it into another collection.
